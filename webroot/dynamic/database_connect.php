...
//password = The password to connect to the database.
  function db_connect($server = 'localhost', $username = 'root', $password = 'root', $database = 'storybooks', $link = 'db_link') {
  //function db_connect($server = 'localhost', $username = 'root', $password = 'root', $database = 'test', $link = 'db_link') {
    global $$link;
